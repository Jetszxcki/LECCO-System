...
Route::post('check_vouchers', 'CheckVouchersController@store')->name('check_vouchers.store')->middleware(['auth', 'accessRight:check_vouchers_view_list,check_vouchers_create']);
