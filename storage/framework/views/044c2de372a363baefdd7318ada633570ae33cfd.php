		...
		<div class="card">
			...
			<div class="card-body">
				<form action="<?php echo e(route('members.store')); ?>" method="POST">
					<?php echo $__env->make('partials.form', ['columns' => $columns, 'route' => 'members.index', 'buttonText' => 'Add Member'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				</form>	
			</div>
		</div>
	</div>	
