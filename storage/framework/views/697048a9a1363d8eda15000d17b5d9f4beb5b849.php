<?php $__env->startSection('title', $member->full_name . ' - Edit Profile'); ?>
		...
		<div class="card">
			...
			<div class="card-body">
				<form action="<?php echo e(route('members.update', [$member])); ?>" method="POST">
					...
					<?php echo $__env->make('members.form', ['columns' => $columns, 'buttonText' => 'Save Changes'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				</form>	
			</div>
		</div>
	</div>	
