	...
	<table class="container" id="main-table">
		...
		<?php $__currentLoopData = $shares; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $share): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<tr class="p-1 mb-2 text-center">
				...
				<td class="col"><?php echo e($share->member->full_name); ?></td>
				<td class="col-md-1"><?php echo e($share->total); ?></td>
				<td class="col-md-1"><?php echo e($share->amount); ?></td>
				<td class="col-md-1"><?php echo e($share->price); ?></td>
				<td nosearch class="col d-flex flex-row align-items-center justify-content-center">
					<a href="<?php echo e(route('shares.show', [$share])); ?>" class="btn btn-success">View</a>
				</td>
			</tr>
